...
object TriviaInsideNode extends DeltaWithGrammar {
  ...
  override def transformGrammars(grammars: LanguageGrammars, language: Language): Unit = {
    ...
    val expected = """List(TriviasGrammar BodyGrammar TriviasGrammar <INSIDE> ProgramGrammar, TriviasGrammar BodyGrammar TriviasGrammar <INSIDE> TriviasGrammar BodyGrammar TriviasGrammar, TriviasGrammar <INSIDE> TriviasGrammar BodyGrammar TriviasGrammar, BodyGrammar TriviasGrammar <INSIDE> TriviasGrammar BodyGrammar TriviasGrammar, TriviaGrammar%* <INSIDE> TriviasGrammar, BodyGrammar TriviasGrammar <INSIDE> BodyGrammar TriviasGrammar, TriviaGrammar <INSIDE> TriviaGrammar%*, BodyGrammar <INSIDE> BodyGrammar TriviasGrammar, TriviasGrammar <INSIDE> BodyGrammar TriviasGrammar,  <INSIDE> TriviaGrammar, TriviaInsideNodeTest.Expression <INSIDE> BodyGrammar, TriviaGrammar%* <INSIDE> TriviasGrammar, | TriviaInsideNodeTest.IntegerClass | TriviaInsideNodeTest.Add <INSIDE> TriviaInsideNodeTest.Expression, TriviaGrammar <INSIDE> TriviaGrammar%*, | TriviaInsideNodeTest.IntegerClass <INSIDE> | TriviaInsideNodeTest.IntegerClass | TriviaInsideNodeTest.Add, TriviaInsideNodeTest.Add <INSIDE> | TriviaInsideNodeTest.IntegerClass | TriviaInsideNodeTest.Add,  <INSIDE> TriviaGrammar,  <INSIDE> | TriviaInsideNodeTest.IntegerClass, TriviaInsideNodeTest.IntegerClass <INSIDE> | TriviaInsideNodeTest.IntegerClass, TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Left) TriviasGrammar + TriviasGrammar TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Right) <INSIDE> TriviaInsideNodeTest.Add, (number).As(TriviaInsideNodeTest.Value) <INSIDE> TriviaInsideNodeTest.IntegerClass, TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Left) TriviasGrammar + TriviasGrammar TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Right) <INSIDE> TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Left) TriviasGrammar + TriviasGrammar TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Right), (number).As(TriviaInsideNodeTest.Value) <INSIDE> (number).As(TriviaInsideNodeTest.Value), TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Left) TriviasGrammar + <INSIDE> TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Left) TriviasGrammar + TriviasGrammar TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Right), TriviasGrammar TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Right) <INSIDE> TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Left) TriviasGrammar + TriviasGrammar TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Right), number <INSIDE> (number).As(TriviaInsideNodeTest.Value), TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Left) <INSIDE> TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Left) TriviasGrammar +, TriviasGrammar + <INSIDE> TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Left) TriviasGrammar +, TriviasGrammar TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Right) <INSIDE> TriviasGrammar TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Right), TriviasGrammar + <INSIDE> TriviasGrammar +, TriviasGrammar <INSIDE> TriviasGrammar TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Right), TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Right) <INSIDE> TriviasGrammar TriviaInsideNodeTest.Expression.As(TriviaInsideNodeTest.Right), TriviasGrammar <INSIDE> TriviasGrammar +, + <INSIDE> TriviasGrammar +, TriviaGrammar%* <INSIDE> TriviasGrammar, TriviaGrammar%* <INSIDE> TriviasGrammar, TriviaGrammar <INSIDE> TriviaGrammar%*, TriviaGrammar <INSIDE> TriviaGrammar%*,  <INSIDE> TriviaGrammar,  <INSIDE> TriviaGrammar)"""
