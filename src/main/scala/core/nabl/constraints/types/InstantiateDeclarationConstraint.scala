...
import core.nabl.constraints.scopes.{DeclarationNode, DeclaresDeclaration, DeclaresScope, ScopeNode}
import core.nabl.constraints.scopes.objects.{Scope, ScopeVariable}
import core.nabl.constraints.types.objects.{Type, TypeVariable}
