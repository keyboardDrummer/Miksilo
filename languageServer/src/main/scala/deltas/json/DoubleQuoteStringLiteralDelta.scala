...
object DoubleQuoteStringLiteralDelta extends DeltaWithGrammar with ExpressionInstance {

  override def description: String = "Adds the usage of JSON double quoted string literals, " +
