...
//        compiler.compileString(inputStream)
...
//    val state = compiler.compileString(inputStream)
//
...
//    val state = compiler.compileString(SourceUtils.getResourceFile("Object.class"))
//
...
//    val compilation = compiler.compileString(SourceUtils.getResourceFile("Object.class"))
...
//    val compiler = TestLanguageBuilder.build(ClassFileSignatureDecompiler.getDecompiler)
//    val compilation = compiler.compileString(SourceUtils.getResourceFile("String2.class"))
//    val output = TestLanguageBuilder.build(Seq(PrettyPrint()) ++ JavaToByteCodeLanguage.javaCompilerDeltas).compileAst(compilation.program).output
//
...
//    val compiler = TestLanguageBuilder.build(ClassFileSignatureDecompiler.getDecompiler)
//    val state = compiler.compileString(SourceUtils.getResourceFile("System.class"))
...
//    val compiler = TestLanguageBuilder.build(ClassFileSignatureDecompiler.getDecompiler)
//    val state = compiler.compileString(SourceUtils.getResourceFile("PrintStream.class"))
//    val output = TestLanguageBuilder.build(Seq(PrettyPrint()) ++ JavaToByteCodeLanguage.javaCompilerDeltas).compileAst(state.program).output
//
