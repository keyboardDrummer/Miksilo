...
import miksilo.editorParser.parsers.strings.{NoStateParserWriter, StringParserWriter}
import org.scalatest.funsuite.AnyFunSuite

class HistoryTest extends AnyFunSuite with StringParserWriter with NoStateParserWriter {
  
  val arrayOffsetManager = new ArrayOffsetManager(new ParseText("whatever"), false)
